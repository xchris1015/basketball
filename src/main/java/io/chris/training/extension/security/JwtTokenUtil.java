...
public class JwtTokenUtil {
    ...
    static final String USER_CREATED_AT = "user_created_at";
    ...
    public Instant getCreatedAtFromToken(String token) {
        ...
        try {
            final Claims claims = getClaimsFromToken(token);
            Long epoch = (Long) claims.get(USER_CREATED_AT);
            createAt = Instant.ofEpochMilli(epoch);
        } catch (Exception e) {
            createAt = null;
        }
        return createAt;
    ...
    public String generateToken(UserDetails userDetails, Device device) {
        ...
        User converted = (User) userDetails;
        converted.getCreateAt();

        Map<String, Object> claims = new HashMap<>();
        claims.put(CLAIM_KEY_USERNAME, userDetails.getUsername());
        claims.put(USER_CREATED_AT, converted.getCreateAt().toEpochMilli());

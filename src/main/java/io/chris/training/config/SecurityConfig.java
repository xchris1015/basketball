...
//                .password("{noop}password").roles("REGISTERED_USER");
        ...
        protected void configure(HttpSecurity http) throws Exception {
            ...
            http.addFilterAt(jwtAuthenticationFilter, UsernamePasswordAuthenticationFilter.class)
                    ...
                    .and()
                        .authorizeRequests().antMatchers("/api/player/**","/api/team/**","/api/playerstatistic/**").hasAnyRole("REGISTERED_USER")
//                    .and()
//                        .authorizeRequests().antMatchers("/api/playerstatistic/**").hasAnyRole("COACH","PLAYER")
                    .and()
                        .authorizeRequests().antMatchers("/api/user/**").hasAnyRole("ADMIN")
                    .and()
